...
{
    public class FutbolcuConfiguration : IEntityTypeConfiguration<Futbolcu>
    {
        public void Configure(EntityTypeBuilder<Futbolcu> builder)
        {
            builder.HasData(
                new Futbolcu
                {
